...
(function() {
  ...
  function actualizarTituloPeriodo() {
    const titulo = document.getElementById('periodo-actual');
    if (!titulo) return;
  ...
  function mostrarDetallesDia(fecha) {
    const section = document.getElementById('habitaciones-section');
    const titulo = document.getElementById('fecha-seleccionada-title');
